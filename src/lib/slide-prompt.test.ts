...
describe("slide-prompt shared pedagogical contract", () => {
  ...
  // moved ONLY because of these two edits. The hash was generated by
  // reading the live file programmatically, not typed by hand.
  describe("the shared voice and flow contract", () => {
    it("SLIDE_STRUCTURE_REQUIREMENTS is byte-identical to its post-coding-flow-fix value", () => {
      expect(SLIDE_STRUCTURE_REQUIREMENTS.length).toBe(17835);
