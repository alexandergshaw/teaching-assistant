...
// resolveDeckTheme, isGeneratorSelected, graphicsGapReportLine,
// graphicsGapReportLines, and assembleLectureFiles live in
// registry-helpers.assembleLectureFiles.ts (kept this file under the
// 1000-line gate); re-exported here so existing importers are unchanged.
export {
  resolveDeckTheme,
  isGeneratorSelected,
  graphicsGapReportLine,
  graphicsGapReportLines,
  assembleLectureFiles,
} from "@/lib/workflows/registry-helpers.assembleLectureFiles";
