...
// Institution/course/composed fan-out coverage (runWorkflowUnattended's
// fan-out branches, checkpointing, and the ./fanout mock they need) lives in
// the sibling server-runner.fanout.test.ts - split out to keep this file
// under the 1000-line cap. See that file for the rejection-guard replacement
// (composed fan-out) coverage.
