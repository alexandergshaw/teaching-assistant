...
import { buildScriptGenerationDiag } from "@/lib/lms-generation/generation-diag";
...
// GenerateFromSelectionInput/Success, PostGeneratedArtifactInput/Success and
// ListGeneratedArtifactVersionsInput/Success moved to ./action-types.ts (a
// plain leaf, structural split only, no behaviour change) once this file
// pushed past the project's 1000-line ceiling. Safe to move (unlike
// GenerationFailure above): no other file imports these six interfaces by
// name - every consumer of the three actions below imports the ASYNC
// FUNCTIONS and lets TypeScript infer the return shape structurally. See
// that new file's own header comment for the full rationale.
import type {
  GenerateFromSelectionInput,
  GenerateFromSelectionSuccess,
  PostGeneratedArtifactInput,
  PostGeneratedArtifactSuccess,
  ListGeneratedArtifactVersionsInput,
  ListGeneratedArtifactVersionsSuccess,
} from "@/lib/lms-generation/action-types";
