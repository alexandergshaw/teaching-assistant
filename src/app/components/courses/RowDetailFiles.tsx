...
// Row-detail "Materials" and "LMS Exports" (export package) sections -
// ported from the tile system's "materials"/"lmsExports" cases: zip uploads
// stored via Supabase storage, with download/replace/remove.
...
export interface RowDetailFilesProps {
  course: Course;
...
export default function RowDetailFiles({ course, onCourseUpdated, setError, canLms, exportBusy, onExportFromLms }: RowDetailFilesProps) {
