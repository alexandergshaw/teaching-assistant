...
- Use a simple tech stack that deploys to Vercel out of the box — prefer Next.js for full-stack or data-heavy courses, or a plain HTML/CSS/JavaScript static site for lighter courses. Avoid complex backends, managed databases, or infrastructure that would make a Vercel deployment non-trivial. The architecture must be something a beginner can fork, deploy, and iterate on with zero DevOps experience
