...
// The "generate group" describe block moved to ./bulkBarGroups.generate.test.ts
// (1000-line ceiling; mirrors bulkBarGroupCatalog.ts's own split). That file
// declares its own copies of findGroup/findControl/baseFacts rather than
// importing them from here - see its own header comment for why importing a
// *.test.ts file from another one is unsafe under this suite's vitest
// isolation model.
